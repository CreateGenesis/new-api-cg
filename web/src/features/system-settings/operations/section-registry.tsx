...
import { ConfigMigrationSection } from '../maintenance/config-migration-section'
...
const OPERATIONS_SECTIONS = [
  ...
  {
    id: 'config-migration',
    titleKey: 'Configuration Migration',
    build: (_settings: OperationsSettings) => <ConfigMigrationSection />,
  },
] as const
