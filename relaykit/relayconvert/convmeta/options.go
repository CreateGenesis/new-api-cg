...
type ClaudeOptions struct {
	// ProviderManagedReasoning leaves reasoning controls to a host provider
	// adapter whose Messages API uses its own effort and budget semantics.
	ProviderManagedReasoning bool
