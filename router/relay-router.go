...
func SetRelayRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.UserRequestRateLimit())
	{
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.UserRequestConcurrencyLimit(), middleware.Distribute())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.UserRequestConcurrencyLimit(), middleware.Distribute())
	{
